...
local function createDynamicIsland()
	...
	pinnedTitle.TextSize = 13
	pinnedTitle.TextXAlignment = Enum.TextXAlignment.Left
	pinnedTitle.TextTruncate = Enum.TextTruncate.AtEnd
	pinnedTitle.Parent = pinnedInfo
